...
Técnico en Desarrollo de Aplicaciones Multiplataforma (DAM) en formación. Actualmente resido en Castelldefels, Barcelona.

Me considero una persona con gran capacidad de adaptación y enfoque en la resolución de problemas. Mi objetivo es consolidar mis conocimientos técnicos en entornos de trabajo reales y seguir creciendo dentro del sector del desarrollo de software.
...
* Compromiso y responsabilidad en los proyectos.
* Capacidad de aprendizaje continuo y adaptabilidad a nuevas tecnologías.

### Formación académica
* **Cicle Superior d'Informàtica (DAM)** | En curso | La Salle Gràcia
* **Bachillerato Tecnológico** | 2023 - 2025 | Sant Gabriel Viladecans
